/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ai-workflow/wrangler.toml` (hash: 2b2b66bdecfde8ba0472dd7f5400ff94)
// Runtime types generated with workerd@1.20260508.1 2024-11-18 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./ai-workflow/src/index");
	}
	interface Env {
		CONVERSATION_HISTORY: KVNamespace;
		R2: R2Bucket;
		AI: Ai;
		AI_WORKFLOW: Workflow<Parameters<import("./ai-workflow/src/index").AIWorkflow['run']>[0]['payload']>;
	}
}
